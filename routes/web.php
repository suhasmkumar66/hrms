...
Route::group(['middleware' => 'auth'], function () {
	...
	// Company Section //
	Route::get('/setting/companies', 'CompanyController@index');
	Route::get('/setting/companies/create', 'CompanyController@create');
	Route::post('/setting/companies/store', 'CompanyController@store');
	Route::get('/setting/companies/published/{id}', 'CompanyController@published');
	Route::get('/setting/companies/unpublished/{id}', 'CompanyController@unpublished');
	Route::get('/setting/companies/details/{id}', 'CompanyController@show');
	Route::get('/setting/companies/edit/{id}', 'CompanyController@edit');
	Route::post('/setting/companies/update/{id}', 'CompanyController@update');
	Route::get('/setting/companies/edit/{id}', 'CompanyController@edit');
	...
	Route::get('/people/export', 'EmplController@export')->name('export');
	Route::post('/people/import', 'EmplController@import')->name('import');
	Route::post('/getDepartmentUser', 'EmplController@getDepartmentUser');
	...
	Route::post('/hrm/attendance/import', 'AttendanceController@import')->name('attendanceimport');
	...
	Route::get('/hrm/salary-payments/?dpt_id={department_id}/?month={salary_month}', 'SalaryPaymentController@index');
	...
	Route::post('/bulksalarypayment','SalaryPaymentController@make_bulkpayment');
