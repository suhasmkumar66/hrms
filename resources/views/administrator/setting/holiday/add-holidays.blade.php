      ...
      <form action="{{ url('setting/holidays/store') }}" method="post" name="holidays_add_form">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              <label for="holiday_name">{{ __('Holiday Name') }} <span class="text-danger">*</span></label>
              <div class="form-group{{ $errors->has('holiday_name') ? ' has-error' : '' }} has-feedback">
                <input type="text" name="holiday_name" id="holiday_name" class="form-control" value="{{ old('holiday_name') }}" placeholder="{{ __('Enter Holiday name..') }}">
            ...
            <!-- /.col -->
            <div class="col-md-12">
              <label for="description">{{ __('Holiday Description ') }}</label>
