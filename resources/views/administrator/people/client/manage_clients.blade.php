...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="col-md-1">
                    <a href="{{ url('/people/clients/create') }}" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> {{ __('Customer') }}</a>
                </div>
                <div class="col-md-1"></div>
                
                <div  class="col-md-9">  <input type="text" id="myInput" class="form-control search-float" placeholder="{{ __('Search..') }}"></div>
               <div class="col-md-1">
