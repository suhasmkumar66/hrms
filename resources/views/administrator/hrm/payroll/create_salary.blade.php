            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="ctc" class="form-control" id="ctc" value="{{ old('basic_salary') }}" placeholder="{{ __('Enter Gross..') }}" onchange="salarycal()">
                    @if ($errors->has('ctc'))
                    <span class="help-block">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                ...
                <input type="number" name="basic_salary" value="{{ old('basic_salary') }}" class="form-control" id="basic_salary" placeholder="{{ __('Enter Basic + DA..') }}">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group{{ $errors->has('employee_pf') ? ' has-error' : '' }}">
                ...
                <input type="number" name="employee_pf" value="{{ old('provident_fund_deduction') }}" class="form-control" id="employee_pf" placeholder="{{ __('Enter provident fund deduction..') }}">
              ...
              <div class="form-group{{ $errors->has('employee_esi') ? ' has-error' : '' }}">
                ...
                <input type="number" name="employee_esi" value="{{ old('other_deduction') }}" class="form-control" id="employee_esi" placeholder="{{ __('Enter other deduction..') }}">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group{{ $errors->has('employeer_pf') ? ' has-error' : '' }}">
                <label for="provident_fund_deduction">{{ __('Provident Fund Deduction') }}</label>
                <input type="number" name="employeer_pf" value="{{ old('provident_fund_deduction') }}" class="form-control" id="employeer_pf" placeholder="{{ __('Enter provident fund deduction..') }}">
              ...
              <div class="form-group{{ $errors->has('employeer_esi') ? ' has-error' : '' }}">
                <label for="other_deduction">{{ __('ESI Deduction') }}</label>
                <input type="number" name="employeer_esi" value="{{ old('other_deduction') }}" class="form-control" id="employeer_esi" placeholder="{{ __('Enter other deduction..') }}">
