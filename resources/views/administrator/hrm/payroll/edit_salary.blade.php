...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ url('/hrm/payroll/salary-list') }}">{{ __('Payroll') }}</a></li>
      ...
      <form name="employee_salary_form" id="employee_salary_form" action="{{ url('/hrm/payroll/update/' . $salary['id']) }}" method="post">
          ...
          <div class="box box-info">
            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                  <label for="basic_salary" class="col-sm-3 control-label">{{ __('Gross Salary') }}</label>
                  <div class="col-sm-6">
                    <input type="number" name="ctc" class="form-control" id="ctc" value="{{ $salary['ctc'] }}" placeholder="{{ __('Enter Gross..') }}" onchange="salarycal()">
                    @if ($errors->has('ctc'))
                    <span class="help-block">
        ...
        <div class="col-md-6">
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group{{ $errors->has('basic_salary') ? ' has-error' : '' }}">
                <label for="basic_salary">{{ __('Basic + DA') }}</label>
                <input type="number" name="basic_salary" value="{{ $salary['basic_salary'] }}" class="form-control" id="basic_salary" placeholder="{{ __('Enter Basic + DA..') }}">
...
<!--               </div> -->
        ...
        <div class="col-md-6">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">{{ __('Employee Deductions') }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="form-group{{ $errors->has('employee_pf') ? ' has-error' : '' }}">
                ...
                <input type="number" name="employee_pf" value="{{ $salary['employee_pf'] }}" class="form-control" id="employee_pf" placeholder="{{ __('Enter provident fund deduction..') }}">
                @if ($errors->has('employee_pf'))
                <span class="help-block">
                  <strong>{{ $errors->first('employee_pf') }}</strong>
                </span>
                @endif
              </div>
              <div class="form-group{{ $errors->has('employee_esi') ? ' has-error' : '' }}">
                <label for="other_deduction">{{ __('ESI Deduction') }}</label>
                <input type="number" name="employee_esi" value="{{ $salary['employee_esi'] }}" class="form-control" id="employee_esi" placeholder="{{ __('Enter other deduction..') }}">
              ...
              <div class="form-group{{ $errors->has('other_deduction') ? ' has-error' : '' }}">
                <label for="other_deduction">{{ __('Professional Tax') }}</label>
                ...
                @if ($errors->has('employee_esi'))
                <span class="help-block">
                  <strong>{{ $errors->first('employee_esi') }}</strong>
                </span>
                @endif
              </div>
            </div>
        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">{{ __('Employeer Deductions') }}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="form-group{{ $errors->has('employeer_pf') ? ' has-error' : '' }}">
                <label for="provident_fund_deduction">{{ __('Provident Fund Deduction') }}</label>
                <input type="number" name="employeer_pf" value="{{ $salary['employeer_pf'] }}" class="form-control" id="employeer_pf" placeholder="{{ __('Enter provident fund deduction..') }}">
                @if ($errors->has('employeer_pf'))
                <span class="help-block">
                  <strong>{{ $errors->first('employeer_pf') }}</strong>
                </span>
                @endif
              </div>
              <div class="form-group{{ $errors->has('employeer_esi') ? ' has-error' : '' }}">
                <label for="other_deduction">{{ __('ESI Deduction') }}</label>
                <input type="number" name="employeer_esi" value="{{ $salary['employeer_esi'] }}" class="form-control" id="employeer_esi" placeholder="{{ __('Enter other deduction..') }}">
                @if ($errors->has('employeer_esi'))
                <span class="help-block">
                  <strong>{{ $errors->first('employeer_esi') }}</strong>
                </span>
                @endif
              </div>
            </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="form-group">
                <label for="gross_salary">{{ __('CTC') }}</label>
                <input type="number" readonly class="form-control" name="gross_salary" id="gross_salary" value="{{$salary['gross_salary']}}">
              </div>
              <div class="form-group{{ $errors->has('total_deduction') ? ' has-error' : '' }}">
                <label for="total_deduction">{{ __('Total Deduction') }}</label>
                <input type="number" readonly class="form-control" name="total_deduction" id="total_deduction" value="{{$salary['total_deduction']}}" >
              </div>
              <div class="form-group">
                <label for="net_salary">{{ __('Net Salary') }}</label>
                <input type="number" readonly class="form-control" name="net_salary" id="net_salary" value="{{$salary['net_salary']}}">
              </div>
            </div>
            <!-- /.box-body -->
            ...
            <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> {{ __('Update') }}</button>
                     <a href="{{ url('/hrm/payroll/salary-list') }}" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i>{{ __('Cancel') }} </a>
                </div>
          </div>
        </div>
        <!-- /.end.col -->
