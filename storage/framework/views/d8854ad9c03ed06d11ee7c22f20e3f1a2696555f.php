...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(url('/hrm/payroll/salary-list')); ?>"><?php echo e(__('Payroll')); ?></a></li>
      ...
      <form name="employee_salary_form" id="employee_salary_form" action="<?php echo e(url('/hrm/payroll/update/' . $salary['id'])); ?>" method="post">
          ...
          <div class="box box-info">
            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group<?php echo e($errors->has('basic_salary') ? ' has-error' : ''); ?>">
                  <label for="basic_salary" class="col-sm-3 control-label"><?php echo e(__('Gross Salary')); ?></label>
                  <div class="col-sm-6">
                    <input type="number" name="ctc" class="form-control" id="ctc" value="<?php echo e($salary['ctc']); ?>" placeholder="<?php echo e(__('Enter Gross..')); ?>" onchange="salarycal()">
                    <?php if($errors->has('ctc')): ?>
                    <span class="help-block">
                      <strong><?php echo e($errors->first('ctc')); ?></strong>
                    </span>
                    <?php endif; ?>
                  </div>
                </div>
        ...
        <div class="col-md-6">
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group<?php echo e($errors->has('basic_salary') ? ' has-error' : ''); ?>">
                <label for="basic_salary"><?php echo e(__('Basic + DA')); ?></label>
                <input type="number" name="basic_salary" value="<?php echo e($salary['basic_salary']); ?>" class="form-control" id="basic_salary" placeholder="<?php echo e(__('Enter Basic + DA..')); ?>">
...
<!--               </div> -->
        ...
        <div class="col-md-6">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo e(__('Employee Deductions')); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <div class="form-group<?php echo e($errors->has('employee_pf') ? ' has-error' : ''); ?>">
                <label for="provident_fund_deduction"><?php echo e(__('Provident Fund Deduction')); ?></label>
                <input type="number" name="employee_pf" value="<?php echo e($salary['employee_pf']); ?>" class="form-control" id="employee_pf" placeholder="<?php echo e(__('Enter provident fund deduction..')); ?>">
                <?php if($errors->has('employee_pf')): ?>
                <span class="help-block">
                  <strong><?php echo e($errors->first('employee_pf')); ?></strong>
                </span>
                <?php endif; ?>
              </div>
              <div class="form-group<?php echo e($errors->has('employee_esi') ? ' has-error' : ''); ?>">
                <label for="other_deduction"><?php echo e(__('ESI Deduction')); ?></label>
                <input type="number" name="employee_esi" value="<?php echo e($salary['employee_esi']); ?>" class="form-control" id="employee_esi" placeholder="<?php echo e(__('Enter other deduction..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('other_deduction') ? ' has-error' : ''); ?>">
                <label for="other_deduction"><?php echo e(__('Professional Tax')); ?></label>
                ...
                <?php if($errors->has('employee_esi')): ?>
                <span class="help-block">
                  <strong><?php echo e($errors->first('employee_esi')); ?></strong>
                </span>
                <?php endif; ?>
              </div>
            </div>
        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo e(__('Employeer Deductions')); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="form-group<?php echo e($errors->has('employeer_pf') ? ' has-error' : ''); ?>">
                <label for="provident_fund_deduction"><?php echo e(__('Provident Fund Deduction')); ?></label>
                <input type="number" name="employeer_pf" value="<?php echo e($salary['employeer_pf']); ?>" class="form-control" id="employeer_pf" placeholder="<?php echo e(__('Enter provident fund deduction..')); ?>">
                <?php if($errors->has('employeer_pf')): ?>
                <span class="help-block">
                  <strong><?php echo e($errors->first('employeer_pf')); ?></strong>
                </span>
                <?php endif; ?>
              </div>
              <div class="form-group<?php echo e($errors->has('employeer_esi') ? ' has-error' : ''); ?>">
                <label for="other_deduction"><?php echo e(__('ESI Deduction')); ?></label>
                <input type="number" name="employeer_esi" value="<?php echo e($salary['employeer_esi']); ?>" class="form-control" id="employeer_esi" placeholder="<?php echo e(__('Enter other deduction..')); ?>">
                <?php if($errors->has('employeer_esi')): ?>
                <span class="help-block">
                  <strong><?php echo e($errors->first('employeer_esi')); ?></strong>
                </span>
                <?php endif; ?>
              </div>
            </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="form-group">
                <label for="gross_salary"><?php echo e(__('CTC')); ?></label>
                <input type="number" readonly class="form-control" name="gross_salary" id="gross_salary" value="<?php echo e($salary['gross_salary']); ?>">
              </div>
              <div class="form-group<?php echo e($errors->has('total_deduction') ? ' has-error' : ''); ?>">
                ...
                <input type="number" readonly class="form-control" name="total_deduction" id="total_deduction" value="<?php echo e($salary['total_deduction']); ?>" >
              </div>
              <div class="form-group">
                <label for="net_salary"><?php echo e(__('Net Salary')); ?></label>
                <input type="number" readonly class="form-control" name="net_salary" id="net_salary" value="<?php echo e($salary['net_salary']); ?>">
              </div>
            </div>
            <!-- /.box-body -->
            ...
            <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo e(__('Update')); ?></button>
                     <a href="<?php echo e(url('/hrm/payroll/salary-list')); ?>" class="btn btn-danger btn-flat"><i class="icon fa fa-close"></i><?php echo e(__('Cancel')); ?> </a>
                </div>
          </div>
        </div>
        <!-- /.end.col -->
...
function salarycal(){
    var ctc = $("#ctc").val();
    var td = $("#tax_deduction").val();
    var oa = $("#other_allowance").val();
    var basic = (ctc/2).toFixed(2);
    var hra = (basic * 0.40).toFixed(2);
    var special = basic - hra;
    if(basic < 15000){
      var employeepf = (basic * 0.12).toFixed(2);
      var employeerpf = (basic * 0.13).toFixed(2);
    }
    else{
      employeepf = (15000 * 0.12).toFixed(2);
      employeerpf = (15000 * 0.13).toFixed(2);
    }
    if(ctc < 15000){
      var pt = 0;
    }
    ...
    var gross = ctc;
    if(gross <= 21000){
      var employeeesi = (gross * 0.0075).toFixed(2);
    var employeeresi = (gross * 0.0325).toFixed(2);
    }
    else{
      employeeesi = 0;
      employeeresi = 0;
    ...
    var takehome = parseFloat(parseFloat(ctc) - parseFloat(employeepf)  - parseFloat(pt) - parseFloat(employeeesi));
    var totaldedcution = parseFloat(parseFloat(employeepf)  + parseFloat(pt) + parseFloat(employeeesi)+ parseFloat(tax_ded));
    var ctcgrand = parseFloat(parseFloat(gross) + parseFloat(employeeresi) + parseFloat(employeerpf) + parseFloat(other_all));
    $("#basic_salary").val(basic);
    $("#house_rent_allowance").val(hra);
    $("#special_allowance").val(special);
    $("#employee_pf").val(employeepf);
    $("#employeer_pf").val(employeerpf);
    $("#other_deduction").val(pt);
    $("#employee_esi").val(employeeesi);
    $("#employeer_esi").val(employeeresi);
    $("#gross_salary").val(ctcgrand);
    $("#total_deduction").val(totaldedcution);
    $("#net_salary").val(takehome);
   }
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrms\resources\views/administrator/hrm/payroll/edit_salary.blade.php ENDPATH**/ ?>