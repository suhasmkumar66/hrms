    ...
    <div class="box box-default">
      ...
      <form action="<?php echo e(url('/hrm/expence/category/store')); ?>" method="post" name="add_form_expence">
        ...
        <div class="box-footer">
          ...
          <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo e(__('Add Category')); ?></button>
        </div>
      </form>
    </div>
    <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\hrm-projects\Laravel-HRMS\resources\views/administrator/hrm/expence/expensePurposeAdd.blade.php ENDPATH**/ ?>