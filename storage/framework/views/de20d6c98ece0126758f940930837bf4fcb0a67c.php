...
<div class="content-wrapper">
  ...
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
     <form action="<?php echo e(route('attendanceimport')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrms\resources\views/administrator/hrm/attendance/manage_attendance.blade.php ENDPATH**/ ?>