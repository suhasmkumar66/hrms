            ...
            <form action="<?php echo e(url('setting/designations/store')); ?>" method="post" name="designation_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="designation_description"><?php echo e(__('Designation Description')); ?></label>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/setting/designation/add_designation.blade.php ENDPATH**/ ?>