...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div  class="col-md-1">
                    <a href="<?php echo e(url('/hrm/expence/add-expence')); ?>" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i> <?php echo e(__('Add New Accounts')); ?></a>
                </div>
				 <div  class="col-md-10">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\hrm-projects\Laravel-HRMS\resources\views/administrator/hrm/expence/manage_expence.blade.php ENDPATH**/ ?>