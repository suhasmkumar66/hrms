                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <img src="<?php echo e(url('profile_picture/' . $user['avatar'])); ?>" alt="$user['avatar']" class="img-responsive img-thumbnail">
                            <?php else: ?>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/profile/user_profile.blade.php ENDPATH**/ ?>