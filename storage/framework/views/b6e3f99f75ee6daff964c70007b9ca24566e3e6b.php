        ...
        <div class="box box-default">
            ...
            <form action="<?php echo e(url('people/clients/update/'.$client['id'])); ?>" method="post" name="client_edit_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="name" id="name" class="form-control" value="<?php echo e($client['name']); ?>" placeholder="<?php echo e(__('Enter name..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="email" id="email" class="form-control" value="<?php echo e($client['email']); ?>" placeholder="<?php echo e(__('Enter email address..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('contact_no_one') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="contact_no_one" id="contact_no_one" class="form-control" value="<?php echo e($client['contact_no_one']); ?>" placeholder="<?php echo e(__('Enter contact no..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('web') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="web" id="web" class="form-control" value="<?php echo e($client['web']); ?>" placeholder="<?php echo e(__('Enter web..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('date_of_birth') ? ' has-error' : ''); ?> has-feedback">
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="date_of_birth" class="form-control pull-right" value="<?php echo e($client['date_of_birth']); ?>" id="datepicker">
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('present_address') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="present_address" id="present_address" class="form-control" value="<?php echo e($client['present_address']); ?>" placeholder="<?php echo e(__('Enter address..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('contact_no_two') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="contact_no_two" id="contact_no_two" class="form-control" value="<?php echo e($client['contact_no_two']); ?>" placeholder="<?php echo e(__('Enter address..')); ?>">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo e(__('Update client')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/people/client/edit_client.blade.php ENDPATH**/ ?>