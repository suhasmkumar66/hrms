       ...
       <?php if (\Entrust::can('file-upload')) : ?>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a href="<?php echo e(url('/setting/companies')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('Manage Company')); ?> </a></li>
                ...
                <li><a href="<?php echo e(url('/setting/holidays')); ?>"><i class="fa fa-circle-o"></i><?php echo e(__('Holiday List')); ?> </a></li>
                 <?php if (\Entrust::can('personal-event')) : ?>
...
</div><?php /**PATH C:\xampp\htdocs\hrms\resources\views/administrator/layouts/menu.blade.php ENDPATH**/ ?>