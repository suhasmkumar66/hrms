            ...
            <form action="<?php echo e(url('/setting/leave_categories/update/'. $leave_category['id'])); ?>" method="post" name="leave_category_edit_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="leave_category_description"><?php echo e(__('Category Description')); ?> </label>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/setting/leave_category/edit_leave_category.blade.php ENDPATH**/ ?>