    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__('Edit company')); ?></h3>
            ...
            <!-- /.box-header -->
            <form action="<?php echo e(url('/setting/companies/update/'. $company['id'])); ?>" method="post" name="company_edit_form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('company_name') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="company_name" id="company_name" class="form-control" value="<?php echo e($company['company_name']); ?>" placeholder="<?php echo e(__('Enter company name..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('company_code') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="company_code" id="company_code" class="form-control" value="<?php echo e($company['company_code']); ?>" placeholder="<?php echo e(__('Enter company code..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('company_website') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="company_website" id="company_website" class="form-control" value="<?php echo e($company['company_website']); ?>" placeholder="<?php echo e(__('Enter company website..')); ?>">
                        ...
                        <label for="company_contact_number"><?php echo e(__('Company Contact No')); ?></label>
                            <div class="form-group<?php echo e($errors->has('company_contact_number') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="company_contact_number" id="company_contact_number" class="form-control" value="<?php echo e($company['company_contact_number']); ?>" placeholder="<?php echo e(__('Enter company contact no..')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('"company_email"') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="company_email" id="company_email" class="form-control" value="<?php echo e($company['company_email']); ?>" placeholder="<?php echo e(__('Enter company email...')); ?>">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="department_description"><?php echo e(__('Company Description')); ?> </label>
                            <div class="form-group<?php echo e($errors->has('company_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea text-description" name="company_description" id="company_description" placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e($company['company_description']); ?></textarea>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-edit"></i> <?php echo e(__('Update company')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<script type="text/javascript">
    document.forms['company_edit_form'].elements['publication_status'].value = "<?php echo e($company['publication_status']); ?>";
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/setting/company/edit_company.blade.php ENDPATH**/ ?>