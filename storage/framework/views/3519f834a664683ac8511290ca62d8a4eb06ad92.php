        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="st-left-body">
                    <h4>
                    <?php $users= \App\User::all()->where('id', $empid);
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrms\resources\views/administrator/hrm/increment/salaryStatementView.blade.php ENDPATH**/ ?>