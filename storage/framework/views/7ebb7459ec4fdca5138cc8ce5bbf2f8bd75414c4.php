            ...
            <form action="<?php echo e(url('setting/departments/store')); ?>" method="post" name="department_add_form">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-md-12">
                            <label for="department_description"><?php echo e(__('Department Description')); ?></label>
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo e(__('Add Department')); ?>t</button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/setting/department/add_department.blade.php ENDPATH**/ ?>