        ...
        <div class="box box-default">
            ...
            <form action="<?php echo e(url('setting/companies/store')); ?>" method="post" name="company_add_form"  enctype="multipart/form-data">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-flat"><i class="icon fa fa-plus"></i> <?php echo e(__('Add Company')); ?></button>
                </div>
            </form>
        </div>
        <!-- /.box -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/setting/company/add_company.blade.php ENDPATH**/ ?>