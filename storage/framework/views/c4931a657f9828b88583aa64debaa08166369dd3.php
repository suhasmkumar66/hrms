                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group<?php echo e($errors->has('department') ? ' has-error' : ''); ?> has-feedback">
                                <input type="text" name="department" id="department" class="form-control" value="<?php echo e($department['department']); ?>" placeholder="<?php echo e(__('Enter client name..')); ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group<?php echo e($errors->has('department_description') ? ' has-error' : ''); ?> has-feedback">
                                <textarea class="textarea text-description" name="department_description" id="department_description" placeholder="<?php echo e(__('Enter client description..')); ?>"><?php echo e($department['department_description']); ?></textarea>
                                <?php if($errors->has('department')): ?>
                                <span class="help-block">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/setting/department/edit_department.blade.php ENDPATH**/ ?>