          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group<?php echo e($errors->has('holiday_name') ? ' has-error' : ''); ?> has-feedback">
                <input type="text" name="holiday_name" id="holiday_name" class="form-control" value="<?php echo e(old('holiday_name')); ?>" placeholder="<?php echo e(__('Enter Holiday name..')); ?>">
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\HRMS Projects\Laravel-HRMS\resources\views/administrator/setting/holiday/add-holidays.blade.php ENDPATH**/ ?>