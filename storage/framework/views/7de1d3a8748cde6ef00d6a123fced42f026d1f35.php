            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group<?php echo e($errors->has('basic_salary') ? ' has-error' : ''); ?>">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="ctc" class="form-control" id="ctc" value="<?php echo e(old('basic_salary')); ?>" placeholder="<?php echo e(__('Enter Gross..')); ?>" onchange="salarycal()">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group<?php echo e($errors->has('basic_salary') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="basic_salary" value="<?php echo e(old('basic_salary')); ?>" class="form-control" id="basic_salary" placeholder="<?php echo e(__('Enter Basic + DA..')); ?>">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <div class="form-group<?php echo e($errors->has('employee_pf') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="employee_pf" value="<?php echo e(old('provident_fund_deduction')); ?>" class="form-control" id="employee_pf" placeholder="<?php echo e(__('Enter provident fund deduction..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('employee_esi') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="employee_esi" value="<?php echo e(old('other_deduction')); ?>" class="form-control" id="employee_esi" placeholder="<?php echo e(__('Enter other deduction..')); ?>">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group<?php echo e($errors->has('employeer_pf') ? ' has-error' : ''); ?>">
                <label for="provident_fund_deduction"><?php echo e(__('Provident Fund Deduction')); ?></label>
                <input type="number" name="employeer_pf" value="<?php echo e(old('provident_fund_deduction')); ?>" class="form-control" id="employeer_pf" placeholder="<?php echo e(__('Enter provident fund deduction..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('employeer_esi') ? ' has-error' : ''); ?>">
                <label for="other_deduction"><?php echo e(__('ESI Deduction')); ?></label>
                <input type="number" name="employeer_esi" value="<?php echo e(old('other_deduction')); ?>" class="form-control" id="employeer_esi" placeholder="<?php echo e(__('Enter other deduction..')); ?>">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="number" readonly class="form-control" name="gross_salary" id="gross_salary">
              </div>
              <div class="form-group<?php echo e($errors->has('total_deduction') ? ' has-error' : ''); ?>">
                ...
                <input type="number" readonly class="form-control" name="total_deduction" id="total_deduction">
              </div>
              <div class="form-group">
                <label for="net_salary"><?php echo e(__('Net Salary')); ?></label>
                <input type="number" readonly class="form-control" name="net_salary" id="net_salary">
              </div>
            </div>
            <!-- /.box-body -->
...
//   }
   ...
   function salarycal(){
    ...
    var totaldedcution = parseFloat(parseFloat(employeepf)  + parseFloat(pt) + parseFloat(employeeesi));
    var ctcgrand = parseFloat(parseFloat(gross) + parseFloat(employeeresi) + parseFloat(employeerpf))
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hrms\resources\views/administrator/hrm/payroll/create_salary.blade.php ENDPATH**/ ?>